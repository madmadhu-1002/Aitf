        ...
        <>
            <Container fluid>
                <Row className={styles.footer}>
                    <Col md={8}>
                        <Row >
                            <Col className="mb-3 border-bottom border-white p-4" xs={12}>
                                <h3 className="fs-4 w-75">Possibilities Unlimited. <span className="text-primary">One Stop</span> Custom Custom Modifications Hub</h3>
                            </Col>
                            <Col>
                                <Row>
                                    <Col md={4} sm={12}>
