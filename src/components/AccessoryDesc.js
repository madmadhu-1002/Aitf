    ...
    <>
      <Container className='mt-5'>
        <Row>
          ...
          <Col>
            <h2 style={{fontSize:'36px', fontWeight:600}}>Description</h2>
            <p style={{fontSize:'16px', fontWeight:400}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            <Button className={`${styles.btn1}`}>Download Brochure</Button>
          </Col>
        </Row>
      </Container>
      <hr></hr>
      <Container className="mt-5 mb-5">
        <h1 className='text-center' style={{ marginBottom: '0.3rem', fontSize: '36px', fontWeight: 700, color:'#0056A8' }}>Popular Accessories</h1>
        <div
      ...
      <Container fluid className='mt-5 me-0'>
        <Row>
